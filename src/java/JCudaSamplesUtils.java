...
public class JCudaSamplesUtils
{
    ...
    public static String preparePtxFile(String cuFileName, String ... nvccArguments)
    {
    ...
    public static String prepareDefaultCubinFile(String cuFileName, String ... extraArguments) {
        int computeCapability = computeComputeCapability();
        String[] nvccArguments = new String[extraArguments.length + 2];
        nvccArguments[0] = "-dlink";
        nvccArguments[1] = "-arch=sm_"+computeCapability;
        for (int i = 0; i < extraArguments.length; i++) {
            nvccArguments[i+2] = extraArguments[i];
        }
